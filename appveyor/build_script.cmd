...
ECHO.
ECHO *** Try curl:
curl -f -sS -L -o "%APPVEYOR_BUILD_FOLDER%\apvyr_cache\mysql-connector-odbc-5.3.13-win32.msi" "https://downloads.mysql.com/archives/get/p/10/file/mysql-connector-odbc-5.3.13-win32.msi"
IF ERRORLEVEL 1 (
